...
CHANNEL_FOCUS = {
    ...
    "echelon_veil": {
        "focus": [
            "Government programs that were classified, then partially declassified, with key details still redacted",
            "Surveillance technologies that exist but aren't publicly acknowledged",
            "Specific people who disappeared after encountering classified information",
            "Shell companies, front organizations, and money trails that lead nowhere",
            "Signals, frequencies, and broadcasts that serve unknown purposes",
            "Experiments conducted on populations without their knowledge — documented, real cases",
            "Infrastructure that exists but has no official purpose — buildings, roads, tunnels with no records",
            "Whistleblowers whose stories were confirmed years later",
            "Digital anomalies — websites, databases, accounts that exist but shouldn't",
            "The gap between what governments admit and what documents reveal",
        ],
        "avoid": [
            ...
            "Generic 'the government is hiding something' without specific anchors",
        ],
        "examples": [
            "The Phone Number That Connects to No One",
            "The Town That Forgot 48 Hours",
            "The Signal They Told You Was Static",
            "The Budget Line Item That's Been Classified for 40 Years",
            "The Website That Only Loads from Government IP Addresses",
            "The Company That Has No Employees, No Product, and a $2 Billion Valuation",
            "The Document They Declassified with Every Other Word Blacked Out",
            "The Facility That Appears on Satellite Imagery but Not on Any Map",
        ],
    },
    "loreletics": {
        "focus": [
